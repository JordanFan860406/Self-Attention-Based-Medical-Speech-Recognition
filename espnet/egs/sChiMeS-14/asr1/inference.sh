...
do_delta=false
cmvn=/home/ee303/Desktop/espnet/egs/sChiMeS-14/asr1/data/train_sp/cmvn.ark
...
# decoding parameter
recog_model=/home/ee303/Desktop/espnet/egs/sChiMeS-14/asr1/exp/train_sp_pytorch_train_pytorch_transformer/results/model.acc.best
...
if [ ${stage} -le 3 ] && [ ${stop_stage} -ge 3 ]; then
    ...
    echo "Recognized text: ${recog_text}" >> inference.txt
    echo "${recog_text}"
fi
